...
A WordPress plugin to show IDs Column on admin pages for posts, pages, categories, taxonomies and custom post types.
...
Simply check the post ID in the admin page.
